...
public class LogiqlDebugSolverCalTime implements InferenceSolver {
    ...
    public Map<Integer, AnnotationMirror> solve(
        ...
        String numberOfConstraints = "The number of constraints: " + constraints.size() + "\n";
        String timing = "Total time in LogiqlDebugSolver: " + (t_decode_e -t_start) + 
                "\nTime for generating variables: " + (t_variable-t_start) + 
                "\nTime for generating constraints: " + (t_constraint - t_variable) + 
                "\nTime for generating logic file: " + (t_generate_logic - t_constraint) + 
                "\nTime for Logiql solver computing: " + (t_end - t_generate_logic) + 
                "\nTime for decoding the result of Logicblox: " + (t_decode_e - t_end) ;
        System.out.println(numberOfSlots + numberOfConstraints + timing);
        return result;
